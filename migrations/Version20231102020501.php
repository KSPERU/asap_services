 ...
 */
final class Version20231102020501 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__historialservicios AS SELECT id, idservicio_id, idcliente_id, idproveedor_id, hs_fecha, hs_estado FROM historialservicios');
        ...
        $this->addSql('INSERT INTO historialservicios (id, idservicio_id, idcliente_id, idproveedor_id, hs_fecha, hs_estado) SELECT id, idservicio_id, idcliente_id, idproveedor_id, hs_fecha, hs_estado FROM __temp__historialservicios');
